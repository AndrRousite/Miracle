 ...
 * 需要在{@link IConfigManager}的实现类中先inject需要的服务
...
public class RepositoryManager implements IRepositoryManager {
    ...
    /**
     * 注入RetrofitService,在{@link IConfigManager#registerComponents(Context, IRepositoryManager)}中进行注入
     * @param services
     */
    @Override
    ...
    /**
     * 注入CacheService,在{@link IConfigManager#registerComponents(Context, IRepositoryManager)}中进行注入
     * @param services
     */
    @Override
