...
/**
 * <p>com.letion.geetionlib.di.module.ClientModule
 *
 * @author wuqi
 * @describe 提供一些三方库客户端实例的 {@link Module}
 * <p>
 * @date 2018/4/24 0024
 */
@Module
public class ClientModule {
    ...
    @Singleton
    @Provides
    Retrofit provideRetrofit(Application application, @Nullable RetrofitConfiguration
            configuration, Retrofit.Builder builder, OkHttpClient client, HttpUrl httpUrl, Gson
                                     gson) {
        builder
                .baseUrl(httpUrl)//域名
    ...
    @Singleton
    @Provides
    OkHttpClient provideClient(Application application, @Nullable OkhttpConfiguration
