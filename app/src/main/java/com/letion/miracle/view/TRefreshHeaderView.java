...
import com.letion.uikit.xrecycler.IRefreshHeaderView;
 ...
 */
public class TRefreshHeaderView extends LinearLayout implements IRefreshHeaderView {
    private LinearLayout mContainer;
    private ImageView mArrowImageView;
    private TLoadView mProgressBar;
    ...
    public TRefreshHeaderView(Context context) {
        this(context, null);
    }

    public TRefreshHeaderView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TRefreshHeaderView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView(Context context) {
        ...
        LayoutInflater.from(context).inflate(R.layout.lfrecyclerview_header, this);

        mContainer = (LinearLayout) findViewById(R.id.container);
        mArrowImageView = (ImageView) findViewById(R.id.iv_arrow);
        msg = (TextView) findViewById(R.id.msg);
        mProgressBar = (TLoadView) findViewById(R.id.iv_progress);
