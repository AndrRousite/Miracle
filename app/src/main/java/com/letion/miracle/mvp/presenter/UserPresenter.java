...
import com.letion.geetionlib.util.RxUtils;
...
import com.letion.geetionlib.vender.rxerrorhandler.handler.RetryWithDelay;
...
public class UserPresenter extends BasePresenter<UserContract.Model, UserContract.View> {
    ...
    public void requestUsers(final boolean pullToRefresh) {
        ...
        mModel.getUsers(lastUserId, isEvictCache)
                ...
                .compose(RxUtils.bindToLifecycle(mView))//使用 Rxlifecycle,使 Disposable 和 Activity 一起销毁
