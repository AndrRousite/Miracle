...
public final class AlertFactory {
     ...
     */
    public static AlertFactory create(@NonNull final Activity activity) {
        if (activity == null) {
        ...
        AlertFactory.clearCurrent(activity);

        AlertFactory.setActivity(activity);
        AlertFactory.setAlert(new Alert(activity));
    ...
    private static void clearCurrent(@NonNull final Activity activity) {
        ...
        try {
            ...
            Log.e(AlertFactory.class.getClass().getSimpleName(), Log.getStackTraceString(ex));
        }
    }
     ...
     * @return This AlertFactory
     */
    public AlertFactory setTitle(@StringRes final int titleId) {
        if (getAlert() != null) {
     ...
     * @return This AlertFactory
     */
    public AlertFactory setTitle(final String title) {
        if (getAlert() != null) {
     ...
     * @return This AlertFactory
     */
    public AlertFactory setContentGravity(final int gravity) {
        if (getAlert() != null) {
     ...
     * @return This AlertFactory
     */
    public AlertFactory setText(@StringRes final int textId) {
        if (getAlert() != null) {
     ...
     * @return This AlertFactory
     */
    public AlertFactory setText(final String text) {
        if (getAlert() != null) {
     ...
     * @return This AlertFactory
     */
    public AlertFactory setBackgroundColor(@ColorRes final int colorResId) {
     ...
     * @return This AlertFactory
     */
    public AlertFactory setBackgroundDrawable(final Drawable drawable) {
        if (getAlert() != null) {
     ...
     * @return This AlertFactory
     */
    public AlertFactory setBackgroundResource(@DrawableRes final int drawableResId) {
        if (getAlert() != null) {
     ...
     * @return This AlertFactory
     */
    public AlertFactory setIcon(@DrawableRes final int iconId) {
        if (getAlert() != null) {
     ...
     * @return This AlertFactory
     */
    public AlertFactory setIcon(@NonNull final Bitmap bitmap) {
        if (getAlert() != null) {
     ...
     * @return This AlertFactory
     */
    public AlertFactory setOnClickListener(@NonNull final View.OnClickListener onClickListener) {
        if (getAlert() != null) {
     ...
     * @return This AlertFactory
     */
    public AlertFactory setDuration(@NonNull final long milliseconds) {
        if (getAlert() != null) {
     ...
     * @return This AlertFactory
     */
    public AlertFactory enableIconPulse(final boolean pulse) {
        if (getAlert() != null) {
     ...
     * @return This AlertFactory
     */
    public AlertFactory showIcon(final boolean showIcon) {
        if (getAlert() != null) {
     ...
     * @return This AlertFactory
     */
    public AlertFactory enableInfiniteDuration(final boolean infiniteDuration) {
        if (getAlert() != null) {
     ...
     * @return This AlertFactory
     */
    public AlertFactory setOnShowListener(@NonNull final OnShowAlertListener listener) {
        if (getAlert() != null) {
     ...
     * @return This AlertFactory
     */
    public AlertFactory setOnHideListener(@NonNull final OnHideAlertListener listener) {
        if (getAlert() != null) {
     ...
     * @return This AlertFactory
     */
    public AlertFactory enableVibration(final boolean enable) {
        if (getAlert() != null) {
     ...
     * @return This AlertFactory
     */
    public AlertFactory disableOutsideTouch() {
        if (getAlert() != null) {
    ...
    /**
     * Gets the Alert associated with the AlertFactory
     *
     ...
     *
     * @return The Decor View of the Activity the AlertFactory was called from
     */
    @Nullable
