...
public class Alert extends FrameLayout implements View.OnClickListener, Animation.AnimationListener {
    ...
    private void initView() {
        inflate(getContext(), R.layout.layout_alert_view, this);
    ...
    protected void onMeasure(final int widthMeasureSpec, final int heightMeasureSpec) {
        ...
        if (!marginSet) {
            ...
            params.topMargin = (int) (-26 * getResources().getDisplayMetrics().density + 0.5f);
            requestLayout();
        }
    }
    ...
    public int getContentGravity() {
        return ((FrameLayout.LayoutParams) rlContainer.getLayoutParams()).gravity;
    }
