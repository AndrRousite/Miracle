package com.letion.uikit.dialog;
...
public class QMUIDialog extends Dialog {
    ...
    public static class MessageDialogBuilder extends QMUIDialogBuilder<MessageDialogBuilder> {
        ...
        public MessageDialogBuilder(Context context) {
            ...
            mTextView.setTextColor(QMUIResHelper.getAttrColor(mContext, R.attr
                    .qmui_config_color_gray_4));
            mTextView.setLineSpacing(QMUIDisplayHelper.dpToPx(2), 1.0f);
            mTextView.setTextSize(TypedValue.COMPLEX_UNIT_PX, QMUIResHelper.getAttrDimen
                    (mContext, R.attr.qmui_dialog_content_message_text_size));
        }
        ...
        protected void onCreateContent(QMUIDialog dialog, ViewGroup parent) {
            if (mMessage != null && mMessage.length() != 0) {
                ...
                mTextView.setPadding(
                        ...
                        QMUIResHelper.getAttrDimen(mContext, hasTitle() ? R.attr
                                .qmui_dialog_content_padding_top : R.attr
                                .qmui_dialog_content_padding_top_when_no_title),
                        QMUIResHelper.getAttrDimen(mContext, R.attr.qmui_dialog_padding_horizontal),
                        QMUIResHelper.getAttrDimen(mContext, R.attr
                                .qmui_dialog_content_padding_bottom)
                );
     ...
     */
    public static class CheckBoxMessageDialogBuilder extends
            QMUIDialogBuilder<CheckBoxMessageDialogBuilder> {
        ...
        protected void onCreateContent(QMUIDialog dialog, ViewGroup parent) {
            if (mMessage != null && mMessage.length() != 0) {
                ...
                mTextView.setPadding(
                        QMUIResHelper.getAttrDimen(mContext, R.attr.qmui_dialog_padding_horizontal),
                        QMUIResHelper.getAttrDimen(mContext, hasTitle() ? R.attr
                                .qmui_dialog_confirm_content_padding_top : R.attr
                                .qmui_dialog_content_padding_top_when_no_title),
                        QMUIResHelper.getAttrDimen(mContext, R.attr.qmui_dialog_padding_horizontal),
                        QMUIResHelper.getAttrDimen(mContext, R.attr
                                .qmui_dialog_confirm_content_padding_bottom)
                );
                mCheckMarkDrawable.setBounds(0, 0, mCheckMarkDrawable.getIntrinsicWidth(),
                        mCheckMarkDrawable.getIntrinsicHeight());
    ...
    public static class EditTextDialogBuilder extends QMUIDialogBuilder<EditTextDialogBuilder> {
        ...
        public EditTextDialogBuilder(Context context) {
            ...
            mEditText.setHintTextColor(QMUIResHelper.getAttrColor(mContext, R.attr
                    .qmui_config_color_gray_3));
            mEditText.setTextColor(QMUIResHelper.getAttrColor(mContext, R.attr
                    .qmui_config_color_black));
            mEditText.setTextSize(TypedValue.COMPLEX_UNIT_PX, QMUIResHelper.getAttrDimen
                    (mContext, R.attr.qmui_dialog_content_message_text_size));
         ...
         */
        public EditTextDialogBuilder setTransformationMethod(TransformationMethod
        ...
        protected void onCreateContent(QMUIDialog dialog, ViewGroup parent) {
            ...
            lp.topMargin = QMUIResHelper.getAttrDimen(mContext, hasTitle() ? R.attr
                    .qmui_dialog_edit_content_padding_top : R.attr
                    .qmui_dialog_content_padding_top_when_no_title);
            lp.leftMargin = QMUIResHelper.getAttrDimen(mContext, R.attr
                    .qmui_dialog_padding_horizontal);
            lp.rightMargin = QMUIResHelper.getAttrDimen(mContext, R.attr
                    .qmui_dialog_padding_horizontal);
            lp.bottomMargin = QMUIResHelper.getAttrDimen(mContext, R.attr
                    .qmui_dialog_edit_content_padding_bottom);
            ...
            RelativeLayout.LayoutParams editLp = new RelativeLayout.LayoutParams(ViewGroup
        ...
        protected RelativeLayout.LayoutParams createRightIconLayoutParams() {
            RelativeLayout.LayoutParams rightIconLp = new RelativeLayout.LayoutParams(ViewGroup
    ...
    private static class MenuBaseDialogBuilder<T extends QMUIDialogBuilder> extends
            QMUIDialogBuilder<T> {
        ...
        public MenuBaseDialogBuilder(Context context) {
            ...
            mMenuItemLp = new LinearLayout.LayoutParams(
                    ...
                    QMUIResHelper.getAttrDimen(mContext, R.attr
                            .qmui_dialog_content_list_item_height)
            );
        ...
        protected void onCreateContent(QMUIDialog dialog, ViewGroup parent) {
            ...
            mMenuItemContainer.setPadding(
                    0, QMUIResHelper.getAttrDimen(mContext, R.attr
                            .qmui_dialog_content_padding_top_when_list),
                    0, QMUIResHelper.getAttrDimen(mContext, mActions.size() > 0 ? R.attr
                            .qmui_dialog_content_padding_bottom : R.attr
                            .qmui_dialog_content_padding_bottom_when_no_action)
            );
            ...
            if (mMenuItemViews.size() == 1) {
                ...
                if (hasTitle()) {
                    QMUIViewHelper.setPaddingTop(mMenuItemContainer, QMUIResHelper.getAttrDimen
                            (mContext, R.attr.qmui_dialog_content_padding_top_when_list));
                }
                if (mActions.size() > 0) {
                    QMUIViewHelper.setPaddingBottom(mMenuItemContainer, QMUIResHelper
                            .getAttrDimen(mContext, R.attr.qmui_dialog_content_padding_bottom));
                }
            }
     ...
     * 单选类型的对话框 Builder
     */
    public static class CheckableDialogBuilder extends
            MenuBaseDialogBuilder<CheckableDialogBuilder> {
     ...
     * 多选类型的对话框 Builder
     */
    public static class MultiCheckableDialogBuilder extends
            MenuBaseDialogBuilder<MultiCheckableDialogBuilder> {
         ...
         */
        public MultiCheckableDialogBuilder addItems(CharSequence[] items, OnClickListener
                listener) {
            for (CharSequence item : items) {
    ...
    public static abstract class AutoResizeDialogBuilder extends QMUIDialogBuilder {
        ...
        protected void onCreateContent(QMUIDialog dialog, ViewGroup parent) {
            ...
            mScrollerView.setLayoutParams(new LinearLayout.LayoutParams(ViewGroup.LayoutParams
                    .MATCH_PARENT, onGetScrollHeight()));
                ...
                public void onGlobalLayout() {
                    ...
                    if (anchorShouldHeight != mAnchorHeight) {
                        ...
                        LinearLayout.LayoutParams lp = (LinearLayout.LayoutParams)
                                mAnchorBottomView.getLayoutParams();
                        lp.height = mAnchorHeight;
                        mAnchorBottomView.setLayoutParams(lp);
                        LinearLayout.LayoutParams slp = (LinearLayout.LayoutParams) mScrollerView
                                .getLayoutParams();
                        if (onGetScrollHeight() == ViewGroup.LayoutParams.WRAP_CONTENT) {
                            mScrollHeight = Math.max(mScrollHeight, mScrollerView
                                    .getMeasuredHeight());
                        } else {
                        ...
                        LinearLayout.LayoutParams lp = (LinearLayout.LayoutParams) mDialogWrapper
                                .getLayoutParams();
                        int dialogLayoutMaxHeight = mScreenHeight - lp.bottomMargin - lp
                                .topMargin - r.top;
                        ...
                        if (scrollLayoutHeight > dialogLayoutMaxHeight * 0.8) {
                            ...
                            LinearLayout.LayoutParams slp = (LinearLayout.LayoutParams)
                                    mScrollerView.getLayoutParams();
                            slp.height = mScrollHeight;
                            mScrollerView.setLayoutParams(slp);
                        }
                    }
