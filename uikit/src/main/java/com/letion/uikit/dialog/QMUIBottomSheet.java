...
/**
 * Created by liu-feng on 2017/11/15.
 * <p>
 * <p>
 * 提供了以下两种面板样式:
 * <ul>
...
public class QMUIBottomSheet extends Dialog {
    ...
    private void animateDown() {
        ...
        set.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationEnd(Animation animation) {
                 ...
                 */
                mContentView.post(() -> {
                    // java.lang.IllegalArgumentException: View=com.android.internal.policy
                    // .PhoneWindow$DecorView{22dbf5b V.E...... R......D 0,0-1080,1083} not
    ...
    public static class BottomListSheetBuilder {
        ...
        public BottomListSheetBuilder addItem(int imageRes, String text, String tag) {
            Drawable drawable = imageRes != 0 ? ContextCompat.getDrawable(mContext, imageRes) :
                    null;
         ...
         */
        public BottomListSheetBuilder addItem(int imageRes, String text, String tag, boolean
                hasRedPoint) {
            Drawable drawable = imageRes != 0 ? ContextCompat.getDrawable(mContext, imageRes) :
                    null;
        ...
        public BottomListSheetBuilder setOnSheetItemClickListener(OnSheetItemClickListener
        ...
        private View buildViews() {
            ...
            if (needToScroll()) {
                ...
                mDialog.setOnBottomSheetShowListener(() -> mContainerView.setSelection
                        (mCheckedIndex));
            }
        ...
        private boolean needToScroll() {
            int itemHeight = QMUIDisplayHelper.dp2px(mContext,56);
            ...
            if (mTitleTv != null && !TextUtils.isEmpty(mTitle)) {
                totalHeight += QMUIDisplayHelper.dp2px(mContext,56);
            }
        ...
        protected int getContentViewLayoutId() {
            return R.layout.layout_bottom_sheet_list;
        }
        ...
        private static class BottomSheetListItemData {
            ...
            public BottomSheetListItemData(Drawable image, String text, String tag, boolean
                    hasRedPoint) {
                this.image = image;
                this.text = text;
                this.tag = tag;
            ...
            public BottomSheetListItemData(Drawable image, String text, String tag, boolean
                    hasRedPoint, boolean isDisabled) {
                this.image = image;
                this.text = text;
                this.tag = tag;
                this.hasRedPoint = hasRedPoint;
        ...
        private class ListAdapter extends BaseAdapter {
            ...
            public View getView(final int position, View convertView, ViewGroup parent) {
                ...
                if (convertView == null) {
                    ...
                    convertView = inflater.inflate(R.layout.item_bottom_sheet_list, parent,
                            false);
                    holder = new ViewHolder();
                    holder.imageView = (ImageView) convertView.findViewById(R.id
                            .bottom_dialog_list_item_img);
                    holder.textView = (TextView) convertView.findViewById(R.id
                            .bottom_dialog_list_item_title);
                    holder.markView = convertView.findViewById(R.id
                            .bottom_dialog_list_item_mark_view_stub);
    ...
    public static class BottomGridSheetBuilder implements View.OnClickListener {
        ...
        public BottomGridSheetBuilder addItem(int imageRes, CharSequence textAndTag, @Style int
                style) {
            return addItem(imageRes, textAndTag, textAndTag, style, 0);
        }

        public BottomGridSheetBuilder addItem(int imageRes, CharSequence text, Object tag, @Style
                int style) {
        ...
        public BottomGridSheetBuilder setButtonClickListener(View.OnClickListener
                                                                     buttonClickListener) {
        ...
        public BottomGridSheetBuilder addItem(int imageRes, CharSequence text, Object tag, @Style
                int style, int subscriptRes) {
            LayoutInflater inflater = LayoutInflater.from(mContext);
            // 给机会让用的人自定义ItemView
            @SuppressLint("InflateParams") LinearLayout itemView = (LinearLayout) inflater
                    .inflate(R.layout.item_bottom_sheet_grid, null, false);
            // 字体加粗
            ...
            AppCompatImageView imageView = (AppCompatImageView) itemView.findViewById(R.id
                    .grid_item_image);
        ...
        public BottomGridSheetBuilder setOnSheetItemClickListener(OnSheetItemClickListener
                                                                          onSheetItemClickListener) {
            mOnSheetItemClickListener = onSheetItemClickListener;
            return this;
        }
        ...
        private View buildViews() {
            ...
            baseLinearLayout = (LinearLayout) View.inflate(mContext, getContentViewLayoutId(),
                    null);
            LinearLayout firstLine = (LinearLayout) baseLinearLayout.findViewById(R.id
                    .bottom_sheet_first_linear_layout);
            LinearLayout secondLine = (LinearLayout) baseLinearLayout.findViewById(R.id
                    .bottom_sheet_second_linear_layout);
            ...
            int itemWidth = calculateItemWidth(width, maxItemCountEachLine, firstLine
                    .getPaddingLeft(), firstLine.getPaddingRight());
            ...
            if (mBottomButton != null) {
                if (mIsShowButton) {
                    ...
                    int dimen = QMUIDisplayHelper.dp2px(mContext,10);
        ...
        protected int getContentViewLayoutId() {
            return R.layout.layout_bottom_sheet_grid;
        }
         ...
         * @return item 宽度
         */
        private int calculateItemWidth(int width, int maxItemCountInEachLine, int paddingLeft,
                                       int paddingRight) {
            if (mMiniItemWidth == -1) {
                mMiniItemWidth = QMUIDisplayHelper.dp2px(mContext, 84);
            }
        ...
        private void addViewsInSection(SparseArray<View> items, LinearLayout parent, int
                itemWidth) {
        ...
        private void setItemWidth(View itemView, int itemWidth) {
            ...
            if (itemView.getLayoutParams() != null) {
                ...
                itemLp = new LinearLayout.LayoutParams(itemWidth, ViewGroup.LayoutParams
                        .WRAP_CONTENT);
